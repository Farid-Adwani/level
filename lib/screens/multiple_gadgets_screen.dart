...
class MultipleGadgets extends StatefulWidget {
  ...
  MultipleGadgets({Key? key}) : super(key: key);

  @override
  State<MultipleGadgets> createState() => _MultipleGadgetsState();
}

class _MultipleGadgetsState extends State<MultipleGadgets> {
  var _listTextTabToggle = ["Per Month", "Per Day"];
  int _tabTextIndexSelected = 0;
  late Map<DateTime, double> line1;
    bool notYet=false;

  void changeDay() async {
    FirestoreService fs = FirestoreService();

    Profile.hourLine = await fs.getDayHoursMultiple(
    ...
    setState(() {});
      ...
      Profile.hourLine = await fs.getDaysMonthMultiple(
      FirestoreService.selectedMonth);
      setState(() {
