...
class MaleScreen extends StatefulWidget {
  ...
  @override
  State<MaleScreen> createState() => _MaleScreen();
}

class _MaleScreen extends State<MaleScreen> {
      ...
      body: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Expanded(
                  child: _getContent(Profile.Profiles["mkid"], onTapFunction)),
              Expanded(
                  child:
                      _getContent(Profile.Profiles["myoung"], onTapFunction)),
              Expanded(
                  child:
                      _getContent(Profile.Profiles["madult"], onTapFunction)),
              Expanded(
                  child: _getContent(Profile.Profiles["mold"], onTapFunction)),
            ],
          ),
        ),
      ),
