  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: FirebasePhoneAuthHandler(
        ...
        autoRetrievalTimeOutDuration: const Duration(seconds: 120),
        otpExpirationDuration: const Duration(seconds: 120),
        onCodeSent: () {
        ...
        onLoginFailed: (authException, stackTrace) {
          ...
          switch (authException.code) {
            case 'invalid-phone-number':
              ...
              return showSnackBar('Invalid phone number!',col: Colors.redAccent[700]);
            case 'invalid-verification-code':
              // invalid otp entered
              return showSnackBar('The entered OTP is invalid!',col: Colors.redAccent[700]);
            // handle other error codes
            default:
              showSnackBar('You are blocked for spamming!',col: Colors.redAccent[700]);
                ...
                : Container(
                  ...
                  child: Padding(
                    ...
                    child: ListView(
                        ...
                        children: [
                          Text(
                            "Please Enter Your Code ${widget.phoneNumber}",
